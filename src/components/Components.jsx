            ...
            <BrowserRouter basename="/">
                <div className="page-wraper">
                        <Switch>
                            ...
                            <Route path='/home-factory2' exact component={Home2} />
                            ...
                            <Route path='/home-conditioning-repair12' exact component={Home12} />
                            ...
                            <Route path='/services-agricultural' exact component={ServicesAgricultural} />
                            <Route path='/services-automotive' exact component={ServicesAutomotive} />
                            <Route path='/services-chemical' exact component={ServicesChemical} />
                            <Route path='/services-civil' exact component={ServicesCivil} />
                            <Route path='/services-mechanical' exact component={ServicesMechanical} />
                            <Route path='/services-oilgas' exact component={ServicesOilgas} />
                            <Route path='/services-powerenergy' exact component={ServicesPowerEnergy} />
