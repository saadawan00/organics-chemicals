...
var bnr1 = require('./../../images/background/bg-5.jpg');
...
class Projects2 extends React.Component {
    ...
    render() {
        return (
            <>
                <div className="section-full p-t80 p-b50  overlay-wraper bg-cover bg-no-repeat" style={{ backgroundImage: "url(" + bnr1.default + ")" }}>
