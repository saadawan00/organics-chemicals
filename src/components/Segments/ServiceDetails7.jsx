                ...
                <div className="col-lg-8 col-md-12">
                  <div className="section-content">
                    ...
                    <div className="text-left">
                      <h2 className="wt-title">Fertiliser Industry</h2>
                    </div>
                    {/* TITLE END */}
                    <div className="wt-box services-etc m-b30">
                      <p>
                        The fertilizer industry utilizes various chemicals to
                        enhance soil fertility and promote plant growth. We are
                        proud to serve fertiliser industry buy supplying quality
                        chemicals since a decade.
                      </p>
                    ...
                    <div className="service-provide">
                      <h4>Nitrogen-based Fertilizers:</h4>
                      <div className="row" style={{ marginLeft: "25px" }}>
                        <div>
                          <ul className="list-angle-right">
                            <li>
                              <h5>Ammonium Nitrate (NH4NO3)</h5>
                            </li>
                            <li>
                              <h5>Urea (CO(NH2)2)</h5>
                            </li>
                            <li>
                              <h5>Ammonium Sulphate [(NH4)2SO4]</h5>
                            </li>
                            <li>
                              <h5>Ammonium Phosphate [(NH4)3PO4]</h5>
                            </li>
                          </ul>
                        </div>
                    ...
                    <div className="service-provide">
                      <h4>Phosphorus-based Fertilizers:</h4>
                      <div className="row" style={{ marginLeft: "25px" }}>
                        <div>
                          <ul className="list-angle-right">
                            <li>
                              <h5>Triple Superphosphate (Ca(H2PO4)2)</h5>
                            </li>
                            <li>
                              <h5>Monoammonium Phosphate (NH4H2PO4)</h5>
                            </li>
                            <li>
                              <h5>Diammonium Phosphate [(NH4)2HPO4]</h5>
                            </li>
                            <li>
                              <h5>Rock Phosphate</h5>
                            </li>
                            <li>
                              <h5>Potassium-based Fertilizers:</h5>
                            </li>
                            <li>
                              <h5>Potassium Chloride (KCl)</h5>
                            </li>
                            <li>
                              <h5>Potassium Nitrate (KNO3)</h5>
                            </li>
                            <li>
                              <h5>Potassium Sulfate (K2SO4)</h5>
                            </li>
                          </ul>
                        </div>
                        <div className="col-md-6">
                    ...
                    <div className="service-provide">
                      ...
                      <div className="row" style={{ marginLeft: "25px" }}>
                        <div>
                          <ul className="list-angle-right">
                            <li>
                              <h5>Calcium Nitrate (Ca(NO3)2)</h5>
                            </li>
                            <li>
                              <h5>Magnesium Sulfate (MgSO4)</h5>
                            </li>
                            <li>
                              <h5>Calcium Carbonate (CaCO3)</h5>
                            </li>
                          </ul>
                        </div>
                        <div className="col-md-6">
                    ...
                    <div className="service-provide">
                      ...
                      <div className="row" style={{ marginLeft: "25px" }}>
                        <div>
                          <ul className="list-angle-right">
                            <li>
                              <h5>Iron Chelates (Fe-EDTA, Fe-DTPA)</h5>
                            </li>
                            <li>
                              <h5>Manganese Sulfate (MnSO4)</h5>
                            </li>
                            <li>
                              <h5>Zinc Sulfate (ZnSO4)</h5>
                            </li>
                            <li>
                              <h5>Copper Sulfate (CuSO4)</h5>
                            </li>
                            <li>
                              <h5>Boric Acid (H3BO3)</h5>
                            </li>
                            <li>
                              <h5>Molybdenum (Na2MoO4)</h5>
                            </li>
                          </ul>
                        </div>
                        <div className="col-md-6">
                      ...
                      <div className="row" style={{ marginLeft: "25px" }}>
                        <div>
                          <ul className="list-angle-right">
                            ...
                            <li>
                              <h5>
                                Manure (e.g., cow, poultry, or horse manure)
                              </h5>
                            </li>
                            <li>
                              <h5>Bone Meal</h5>
                    ...
                    <div className="service-provide">
                      <h4>Soil Amendments:</h4>
                      <div className="row" style={{ marginLeft: "25px" }}>
                        <div>
                          <ul className="list-angle-right">
                            <li>
                              <h5>Gypsum (CaSO4·2H2O)</h5>
                            </li>
                            <li>
                              <h5>Lime (Calcium Oxide or Calcium Carbonate)</h5>
                            </li>
                          </ul>
                        </div>
                        <div className="col-md-6">
