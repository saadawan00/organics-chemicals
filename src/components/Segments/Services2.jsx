...
const services = [
  {
    ...
    description:
      "Organics provides an extensive range of speciality, organic & inorganic chemicals to cater the unique requirements of various industries & associates.",
  },
  {
    count: "02",
    url: "/chemicals",
    ...
    description:
      "We are a trusted supplier of high quality laboratory products. Our commitment to excellence has made us a prefered scientific partner for our valued customers.",
  },
  {
    count: "03",
    ...
    description:
      "We are proud to introduce industrial instruments as part of our offerings. Our commitment to providing you with the holistic range of solutions to cater your needs more comprehensively.",
  },
];
                      ...
                      <div className="service-border-box">
                        ...
                        >
                          ...
                          <div className="service-box-content">
                            ...
                            <NavLink to={item.url} className="site-button-link">
                              Read More
                            </NavLink>
                          </div>
