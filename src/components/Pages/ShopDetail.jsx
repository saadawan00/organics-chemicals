                  ...
                  <div className="product-detail-info bg-gray p-a30">
                    ...
                    <div className="wt-product-text">
                      <p>
                        ...
                        around art table Nov 28, 2019 Uncategorized Preserve and
                        cherish that pale blue dot are creatures of the cosmos
                        light years Nov 27, 2019 Uncategorized Great turbulent
                        clouds hearts of the stars stirred by starlight sky
                        culture
                      </p>
                    </div>
                    <form method="post" className="cart clearfix ">
                      ...
                      <button
                        type="button"
                        className="site-button-secondry m-r10 site-btn-effect m-b20"
                      >
                        <i className="fa fa-shopping-bag" /> Buy Now
                      </button>
                      <button
                        type="button"
                        className="site-button site-btn-effect m-b20"
                      >
                    ...
                    <div className="tab-content">
                      <div id="web-design-19" className="tab-pane active">
                        <div className=" p-a10">
                          <p className="m-b10">
                            Hundreds of thousands a still more glorious nights
                            around art table Nov 28, 2019 Uncategorized Preserve
                            and cherish that pale blue dot are creatures of the
                            cosmos light years Nov 27, 2019 Uncategorized Great
                            turbulent clouds hearts of the stars stirred by
                            starlight sky culture
                          </p>
                                ...
                                <div className="comment_container">
                                  ...
                                  <div className="comment-text">
                                    ...
                                    <p className="meta">
                                      ...
                                      <span>
                                        <i className="fa fa-clock-o" /> March
                                        20, 2020
                                      </span>
                                    </p>
                                    <div className="description">
                                      <p>
                                        Really happy with this print. The colors
                                        are great, and the paper quality is very
                                        good.
                                      </p>
                                    </div>
                                  </div>
                              ...
                              <li className="comment">
                                <div className="comment_container">
                                  <img
                                    className="avatar avatar-60 photo"
                                    src={
                                      require("./../../images/testimonials/pic2.jpg")
                                        .default
                                    }
                                    alt=""
                                  />
