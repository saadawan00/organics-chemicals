...
import LabScientificPDF from './../../../assets/media/pdf/Lab Scientific Products Organics.pdf';
                ...
                <Sidebar navBarItems={sidebarItems} />
                    <div className="faq-sidebar">
                        <div className="service-side-btn m-b30 site-bg-secondry p-a20 text-white">
                            ...
                            <div className="wt-icon-box-wraper left">
                                <NavLink to={"#"} onClick={() => window.open(LabScientificPDF)} className="btn-block  p-a15 m-tb10">
                                    <span className="text-black m-r10">
