                    ...
                    <div className="col-lg-4 col-md-4 m-b30">
                      <div className="wt-team-1">
                        <div className="wt-media">
                          <img
                            src={
                              require("./../../images/team/pic1.jpg").default
                            }
                            alt=""
                          />
                    ...
                    <div className="col-lg-8 col-md-8 m-b30">
                      <div className="wt-team-1-single">
                        ...
                        <p>
                          ...
                          the corporate improvement programme and for driving
                          operational efficiency across Equinor’s eight business
                          areas. The COO also plays a key role in the further
                          development of Equinor. The role of the COO
                          organisation is to drive consistent long term safe and
                          efficient operational performance and value creation.
                        </p>
                        <ul className="wt-team-1-single-info bg-white">
                          ...
                          <li>
                            <span>Email</span>
                            <span>malcolm-franzcrip@example.com</span>
                          </li>
                        </ul>
                      </div>
                    </div>
