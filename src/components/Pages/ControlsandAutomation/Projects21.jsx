  ...
  return (
    <div key={imageName} className="col-lg-3 col-xs-3 p-60 p-r2 p-t10 p-b30">
      <div className="wt-icon-card shadow d-flex align-items-center flex-column border p-b10 p-t10 p-r4 p-l4 hover-opacity-dim pointer hover-border-blue">
        <img width={80} src={require(`./../../../images/product_images/Actuators, Positioners, Valve Monitors 2/${imageName}.jpg`)} alt="" />
...
class Projects21 extends React.Component {
  ...
  render() {
    const picturesData = [
      { label: "Gearboxes and Accessories", imageName: "Gearboxes and Accessories" },
      { label: "Linear & Rotary Valve", imageName: "Linear & Rotary Valve Monitors" },
      { label: "Multiport Flow Sectors", imageName: "Multiport Flow Sectors" },
      { label: "Precision Control", imageName: "Precision Control Instruments" },
      { label: "Valve Actuators", imageName: "Valve Actuators" },
