  ...
  return (
    <div key={imageName} className="col-lg-3 col-xs-3 p-60 p-r2 p-t10 p-b30">
      <div className="wt-icon-card shadow d-flex align-items-center flex-column border p-b10 p-t10 p-r4 p-l4 hover-opacity-dim pointer hover-border-blue">
        <img width={80} src={require(`./../../../images/product_images/Burners/Burner2/${imageName}.jpg`)} alt="" />
...
class Projects26 extends React.Component {
  ...
  render() {
    const picturesData = [
      { label: "Burner Control", imageName: "Burner Control" },
      { label: "Flame Scanner", imageName: "Flame Scanner" },
      { label: "Ignitors and Reactors", imageName: "Ignitors and Reactors" },
