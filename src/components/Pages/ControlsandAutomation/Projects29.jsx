...
class Projects29 extends React.Component {
  ...
  render() {
    const picturesData = [
      ...
      { label: "Oval Ring Join", imageName: "Oct & Oval Ring Join.jpg" },
      { label: "Packing", imageName: "Packing.jpg" },
      { label: "Ring Joint", imageName: "Ring Joint.png" },
      { label: "Spiral Wound Gasket", imageName: "Spiral Wound Gasket.jpg" },
