  ...
  return (
    <div key={imageName} className="col-lg-3 col-xs-3 p-60 p-r2 p-t10 p-b30">
      <div className="wt-icon-card shadow d-flex align-items-center flex-column border p-b10 p-t10 p-r4 p-l4 hover-opacity-dim pointer hover-border-blue">
        <img width={80} src={require(`./../../../images/product_images/DCS, Data Acquistion/${imageName}.jpg`)} alt="" />
...
class Projects23 extends React.Component {
  ...
  render() {
    const picturesData = [
      { label: "Calibrators", imageName: "Calibrators, Clampmeters" },
      { label: "Controllers & Indicators", imageName: "Controllers & Indicators" },
      { label: "Dust Monitors", imageName: "Gas Analyzers, Dust Monitors" },
      { label: "ORP Analyzers", imageName: "Liquid, pH, ORP Analyzers" },
      { label: "Product Control Systems", imageName: "Product Control Systems" },
      { label: "Thermal Imagers", imageName: "Scanners & Thermal Imagers" },
