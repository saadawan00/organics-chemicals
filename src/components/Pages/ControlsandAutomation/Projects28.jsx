  ...
  return (
    <div key={imageName} className="col-lg-3 col-xs-3 p-60 p-r2 p-t10 p-b30">
      <div className="wt-icon-card shadow d-flex align-items-center flex-column border p-b10 p-t10 p-r4 p-l4 hover-opacity-dim pointer hover-border-blue">
        <img width={80} src={require(`./../../../images/product_images/Heat Exchange Equipment/${imageName}.jpg`)} alt="" />
...
class Projects28 extends React.Component {
  ...
  render() {
    const picturesData = [
      ...
      { label: "Spare Parts", imageName: "Spare Parts" },
      { label: "Plate Heat Exchanger", imageName: "Plate Heat Exchanger" },
      { label: "Filters & Stainers", imageName: "Filters & Stainers" },
      { label: "Tubular Exchanger", imageName: "Air Heat & Tubular Exchanger" },
    ];
        return (
          <>
